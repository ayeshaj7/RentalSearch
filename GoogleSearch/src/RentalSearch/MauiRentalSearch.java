...
import ObjectRepository.MauiObjectRepo;
...
public class MauiRentalSearch {
	...
	public static void main(String[] args) 
	{
		...
		MauiObjectRepo objectrepo= new MauiObjectRepo(driver);
	...
	public void user_search_and_navigate_to_web_site(searchvalue) throws Throwable
	{
		...
		objectrepo.clickMauiWebSiteLink();
	}
	...
	public void user_is_able_to_see_options (results) throws Throwable
	{
		...
		count=objectrepo.checkResultCont();
